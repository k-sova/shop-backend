...
async def refresh_token(
    ...
    try:
        payload = jwt.decode(old_refresh_token, settings.jwt.token, algorithms=[settings.jwt.algorithm])
...
async def access_token(
    ...
    try:
        payload = jwt.decode(refresh_token, settings.jwt.token, algorithms=[settings.jwt.algorithm])
        email: str | None = payload.get("sub")
        token_type: str | None = payload.get("token_type")
